...
class CelebrityFacesDataset(Dataset):
    ...
    def __init__(self, transform=None, max_images=None):
        ...
        print("Loading celebrity faces dataset from Hugging Face...")
        self._load_dataset_info()

        print(f"Found {len(self.image_urls)} celebrity face images")
        ...
        while True:
            ...
            try:
                ...
                for row in data["rows"]:
                    ...
                    if self.max_images and len(self.image_urls) >= self.max_images:
                        return
